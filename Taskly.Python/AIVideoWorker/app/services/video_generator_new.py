...
Supports both Stable Video Diffusion (SVD) and LTX-Video models.
Brings a single image to life by synthesizing a short motion clip.
This module is GPU-friendly (CUDA) and is designed to run on a machine
with a decent NVIDIA GPU.
